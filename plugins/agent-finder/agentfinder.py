...
class _FinderPicker:
    ...
    def _render_results(self) -> list[tuple[str, str]]:
        ...
        for index, result in enumerate(self.results):
            ...
            style = _row_style(selected=selected, supported=_is_supported_media_type(result.media_type))
            fragments.append(
                (
                    style,
    ...
    def _render_details(self) -> list[tuple[str, str]]:
        ...
        title_style = "class:focus" if _is_supported_media_type(result.media_type) else "ansired"
        return [
...
def _is_supported_media_type(media_type: str) -> bool:
    return media_type in {AI_SKILL_MEDIA_TYPE, MCP_SERVER_MEDIA_TYPE, LEGACY_MCP_SERVER_MEDIA_TYPE}
...
def _row_style(*, selected: bool, supported: bool) -> str:
    if selected:
